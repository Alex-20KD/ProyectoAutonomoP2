...
export class AdoptanteService {
  ...
  async findOne(id: string): Promise<Adoptante> {
  ...
  async update(id: string, updateAdoptanteDto: UpdateAdoptanteDto): Promise<Adoptante> {
  ...
  async remove(id: string): Promise<Adoptante> {
