...
export class SolicitudAdopcionService {
  ...
  async findOne(id: string): Promise<SolicitudAdopcion> { // ID es string (UUID)
  ...
  async update(id: string, updateSolicitudAdopcionDto: UpdateSolicitudAdopcionDto): Promise<SolicitudAdopcion> { // ID es string (UUID)
  ...
  async remove(id: string): Promise<SolicitudAdopcion> { // ID es string (UUID)
