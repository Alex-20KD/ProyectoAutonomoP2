...
export class AcuerdoAdopcionService {
  ...
  async findOne(id: string): Promise<AcuerdoAdopcion> { // ID es string (UUID)
  ...
  async update(id: string, updateAcuerdoAdopcionDto: UpdateAcuerdoAdopcionDto): Promise<AcuerdoAdopcion> { // ID es string (UUID)
  ...
  async remove(id: string): Promise<AcuerdoAdopcion> { // ID es string (UUID)
